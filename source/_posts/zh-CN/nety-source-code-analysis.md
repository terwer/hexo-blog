...
categories:
   - 分布式
   - Netty
permalink: /post/nety-source-code-analysis.html
comments: true
toc: true
---
...
直接 IDEA 导入 Maven 项目选择 `pom.xml`​ 即可。

## 新建 demo 项目

在 example 项目下面新建最简单的 demo
